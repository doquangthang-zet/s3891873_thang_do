...
public class PhysicalProduct extends Product implements UsedAsGifts {
   ...
   */
    ...
    public String toString() {
        return "Physical - " + "Name: " + this.getName() + "\t\tDescription: " + this.getDescription() + "\t\tAvailable Quantity: " + this.getQuantityAvailable() + "\t\tPrice: " + this.getPrice() + "\t\tWeight: " + this.getWeight() + "\t\tMessage: " + this.getMessage();
    }
}
