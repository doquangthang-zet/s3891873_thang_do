...
public class DigitalGiftTest {
    ...
    public void stringRepresentationTest() {
        Product p1 = new DigitalGiftProduct("laptop", "Acer Nitro 5", 3, 100, 2);
        ...
        assertEquals("Digital Gift - Name: laptop gaming\t\t\tDescription: Asus Rox\nAvailable Quantity: 5\t\tPrice: 123.0\t\tMessage: null\t\tTax type: Normal Tax", p1.toString());
    }
    
    @Test
    public void canBeUsedAsGift() {
        UsedAsGifts p1 = new DigitalGiftProduct("laptop", "Acer Nitro 5", 3, 123.45, 3);
        Product p2 = new DigitalGiftProduct("laptop", "Acer Nitro 7", 6, 234.56, 3);
